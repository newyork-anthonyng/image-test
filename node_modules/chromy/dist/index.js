...
var Chromy = function (_Document) {
  ...
  (0, _createClass3.default)(Chromy, [{
    ...
    value: function goto(url, options) {
      ...
      var defaultOptions, response, listener, eventName;
    ...
    value: function _screenshotSelector(selector, opts) {
      var scale, pixelRatio, emulation, buffer, rect, clip, screenshotOpts, _ref4, data;
    ...
    key: 'inject',
    value: function inject(type, file_or_buffer) {
      ...
      return _regenerator2.default.async(function inject$(_context42) {
        while (1) {
          switch (_context42.prev = _context42.next) {
            case 0:
              if (!(file_or_buffer instanceof Buffer)) {
                _context42.next = 4;
                break;
              }

              _context42.t0 = file_or_buffer.toString('utf8');
              _context42.next = 7;
              break;
            ...
            case 4:
              _context42.next = 6;
              return _regenerator2.default.awrap(new Promise(function (resolve, reject) {
                fs.readFile(file_or_buffer, { encoding: 'utf-8' }, function (err, data) {
                  if (err) reject(err);
                  resolve(data);
                });
              }).catch(function (e) {
      ...
      return _regenerator2.default.async(function _getChromeVersion$(_context56) {
        while (1) {
          switch (_context56.prev = _context56.next) {
            case 0:
              return _context56.abrupt('return', this.evaluate(function (_) {
